package cn.peacesky.beenews.widget;
...
import cn.peacesky.beenews.util.NetworkUtil;
        ...
        if (!PrefUtils.isSaveNetMode()) {
            ...
            if (!NetworkUtil.isWifiAvailable() && NetworkUtil.isMobileNetAvailable()) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    placeImage = getResources().getDrawable(R.drawable.click_load_image, BeeNewsApp.getContext().getTheme());
                } else {
