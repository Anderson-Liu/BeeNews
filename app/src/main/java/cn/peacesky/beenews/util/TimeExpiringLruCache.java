...
public class TimeExpiringLruCache<K, V> {
    ...
    /**
     * @param maxSize for caches that do not override {@link #sizeOf}, this is the maximum number of entries in the cache. For all other caches, this is
     *                the maximum sum of the sizes of the entries in this cache.
     * @param timeOut timeout in milliseconds, after that period {@link TimeExpiringLruCache#get(Object)} will return null, and remove entry
     */
